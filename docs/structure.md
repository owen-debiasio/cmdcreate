...
- 📁 [utils](https://github.com/owen-debiasio/cmdcreate/tree/main/src/utils)
  ...
  - 📁 [fs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/)
    - 📁
      [core](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/core/)
      - [creation.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/core/creation.rs)
      - [mod.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/core/mod.rs)
      - [read_write.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/core/read_write.rs)
    - [mod.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/mod.rs)
    - [init.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/init.rs)
    - [misc.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/misc.rs)
    - [paths.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/fs/paths.rs)
...
- [lib.rs](https://github.com/owen-debiasio/cmdcreate/blob/main/src/utils/lib.rs)
